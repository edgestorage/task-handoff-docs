...
<figure class="doc-screenshot">
  ...
  <figcaption>Filter Stories by owner node when work is distributed across nodes. The interface shown is in Simplified Chinese.</figcaption>
</figure>
...
<figure class="doc-screenshot">
  <img src="/images/story-session-compact-view.png" alt="AI session attached to a Story">
  <figcaption>A Story keeps goal documents and related Codex or OpenCode sessions in one workspace. The interface shown is in Simplified Chinese.</figcaption>
</figure>
