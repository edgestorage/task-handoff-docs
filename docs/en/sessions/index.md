...
<figure class="doc-screenshot">
  ...
  <figcaption>Create a session with its agent, model, working directory, and permission mode. The interface shown is in Simplified Chinese.</figcaption>
</figure>
...
<figure class="doc-screenshot">
  ...
  <figcaption>Switch between Compact and Conversation views from the session menu. The interface shown is in Simplified Chinese.</figcaption>
</figure>
