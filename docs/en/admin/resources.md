...
<figure class="doc-screenshot">
  ...
  <figcaption>The project registry shows repository URLs, default images, credentials, and references. The interface shown is in Simplified Chinese.</figcaption>
</figure>
