...
<figure class="doc-screenshot">
  ...
  <figcaption>Codex and OpenCode are available from the same session entry point.</figcaption>
</figure>
...
<figure class="doc-screenshot">
  ...
  <figcaption>Select the provider, model, and reasoning level for a session.</figcaption>
</figure>
